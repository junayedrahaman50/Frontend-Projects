...
<h3><button id="leftBtn" onclick="callLBtn()"> < </button> <span id="days"></span>  <button id="rightBtn" onclick="callRBtn()"> > </button></h3>
...
<div class="form-group">
  ...
  <input onclick="addTable()" type="button" class="btn-primary" id="habitInputBtn" value="Add Habit">
                ...
                <table>
                  ...
                  <div class="box border border-primary"><p class="text-secondary"><span id="scoreView"></span><span id="totalScore">0</span></p></div>
          ...
          <script type="text/javascript">
            ...
            var arr = ['Sunday', 'Monday', 'Tuseday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
